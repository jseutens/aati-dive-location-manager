...
function aatidlm_register_settings() {
    ...
    add_settings_section(
        ...
        __('General Settings', AATIDLM_TEXTDOMAIN),
        'aatidlm_render_general_settings',
        'aatidlm_settings'
    );
    add_settings_field(
        'aatidlm_permalink',
        __('Custom Permalink', AATIDLM_TEXTDOMAIN),
...
?>
    <div class="wrap">
        <h1><?php _e('Dive Location Manager Settings', AATIDLM_TEXTDOMAIN); ?></h1>
...
function aatidlm_render_general_settings() {
    echo '<p>' . __('General settings for the Dive Location Manager plugin.', AATIDLM_TEXTDOMAIN) . '</p>';
}
...
?>
    ...
    <p class="description"><?php _e('Enter a custom permalink structure for dive location entries. Make sure this does not conflict with any existing page or post slug.', AATIDLM_TEXTDOMAIN); ?></p>
<?php
}
